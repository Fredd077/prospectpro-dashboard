  ...
  return (
    <div className="w-full max-w-sm space-y-6">
      ...
      <div className="text-center space-y-3">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-foreground">Únete a ProspectPro</h1>
          <p className="text-sm text-muted-foreground mt-0.5">Tu acceso será revisado antes de activarse</p>
        </div>
      </div>
