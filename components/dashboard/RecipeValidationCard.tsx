    ...
    <div className={cn(
      ...
      <div className="flex items-center justify-between px-4 py-2.5 hover:bg-muted/30 transition-colors">
        <div className="flex items-center gap-2">
          ...
          <span className="text-[11px] text-muted-foreground">{validation.scenario.name}</span>
        </div>
        <button
          type="button"
      ...
      {!collapsed && (
        <>
          ...
          <button
            ...
            className="w-full flex items-center justify-between px-4 py-2 border-t border-border hover:bg-muted/20 transition-colors"
          >
