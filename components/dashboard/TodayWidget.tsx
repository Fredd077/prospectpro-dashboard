...
export function TodayWidget({ today, totalReal, totalGoal, hasActivities }: TodayWidgetProps) {
  ...
  return (
    <div className={cn(
      ...
      <Link
        href="/checkin"
        className="shrink-0 flex items-center gap-1 rounded-md border border-primary/30 bg-primary/10 px-3 py-1.5 text-xs font-medium text-primary transition-colors hover:bg-primary/20"
      >
        Actualizar check-in diario
